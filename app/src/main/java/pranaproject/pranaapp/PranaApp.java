...
public class PranaApp extends Application {


    private static PranaApp mInstance;

    public static synchronized PranaApp getInstance() {
        return mInstance;
    }
    ...
    public void onCreate() {
        ...
        if (!ATE.config(this, "light_theme").isConfigured()) {
            ATE.config(this, "light_theme")
                    ...
                    .primaryColorRes(R.color.colorPrimaryDark)
