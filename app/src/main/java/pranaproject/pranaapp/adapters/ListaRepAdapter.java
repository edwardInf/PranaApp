...
public class ListaRepAdapter extends RecyclerView.Adapter<ListaRepAdapter.ItemHolder> {
    ...
    public ListaRepAdapter(Activity context, List<Playlist> arraylist) {
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            NavigationUtils.navigateToPlaylistDetalle(mContext, getPlaylistType(getAdapterPosition()), (long) albumArt.getTag(), String.valueOf(title.getText()), foregroundColor, arraylist.get(getAdapterPosition()).id, null);
        }
