...
import pranaproject.pranaapp.lastfmapi.LastFmClient;
...
import pranaproject.pranaapp.lastfmapi.models.LastfmArtist;
                                ...
                                new DisplayImageOptions.Builder().cacheInMemory(true)
                                    ...
                                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                                        if (isGrid) {
                                            ...
                                            if (mContext != null) {
                                                int textColorPrimary = Config.textColorPrimary(mContext,
                                                        Helpers.getATEKey(mContext));
