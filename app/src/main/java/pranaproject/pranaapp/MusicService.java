...
import pranaproject.pranaapp.helpers.MediaButtonIntentReceiver;
import pranaproject.pranaapp.helpers.MusicPlaybackTrack;
import pranaproject.pranaapp.permissions.Nammu;
import pranaproject.pranaapp.provider.MusicPlaybackState;
...
import pranaproject.pranaapp.utils.TimberUtils.IdType;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "pranaproject.pranaapp.playstatechanged";
    public static final String POSITION_CHANGED = "pranaproject.pranaapp.positionchanged";
    public static final String META_CHANGED = "pranaproject.pranaapp.metachanged";
    public static final String QUEUE_CHANGED = "pranaproject.pranaapp.queuechanged";
    public static final String PLAYLIST_CHANGED = "pranaproject.pranaapp.playlistchanged";
    public static final String REPEATMODE_CHANGED = "pranaproject.pranaapp.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "pranaproject.pranaapp.shufflemodechanged";
    public static final String TRACK_ERROR = "pranaproject.pranaapp.trackerror";
    public static final String TIMBER_PACKAGE_NAME = "pranaproject.pranaapp";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "pranaproject.pranaapp.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "pranaproject.pranaapp.togglepause";
    public static final String PAUSE_ACTION = "pranaproject.pranaapp.pause";
    public static final String STOP_ACTION = "pranaproject.pranaapp.stop";
    public static final String PREVIOUS_ACTION = "pranaproject.pranaapp.previous";
    public static final String PREVIOUS_FORCE_ACTION = "pranaproject.pranaapp.previous.force";
    public static final String NEXT_ACTION = "fpranaproject.pranaapp.next";
    public static final String REPEAT_ACTION = "pranaproject.pranaapp.repeat";
    public static final String SHUFFLE_ACTION = "pranaproject.pranaapp.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "pranaproject.pranaapp.refresh";
    public static final String UPDATE_LOCKSCREEN = "pranaproject.pranaapp.updatelockscreen";
    ...
    private static final String SHUTDOWN = "pranaproject.pranaapp.shutdown";
